...
num_classes = 80
classes = load_classes(cwd + "data/voc.names")

# Set up the neural network
print("Loading network.....")
model = Darknet(cwd + args.cfgfile)
model.load_weights(cwd + args.weightsfile)
...
if not os.path.exists(cwd + args.det):
    os.makedirs(cwd + args.det)
